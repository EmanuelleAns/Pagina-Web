...
<body class="fondo_inicioArt">
    ...
    <div class="contenedor">
      ...
      <div class="banner" class="contenedor"><br><br><br><br><h1 class="banner__descripcion">Canserbero</h1></div>

      <div><h3 class="noticias_art">Género rap.</h3>

      <img src="<?php echo base_url(); ?>Assets/img/mas1.jpg" class="art_img">
      <P class="noticia_art1">#Pensando en ti#</P>

      <P class="noticia_part">Pensando En Ti es una canción de Rap interpretada y escrita por el rapero venezolano Canserbero. Esta canción salió incluida en el primer álbum de estudio de Canserbero llamado Vida, en el año 2010, pero el video oficial salió en 2011. La canción es el décimo track del disco y primer sencillo de dicho álbum. La temática de la canción es de amor y fue producida por Kpu, mientras la productora del video fue la compañia VisualEyce. Esta canción fue la que hizo conocido a Canserbero dentro del Rap. El vídeo oficial cuenta con 33 millones de visitas en Youtube.</P></div>

      <br><P class="noticia_part2">Hablamos con un psicólogo, una socióloga y un poeta sobre las letras de Canserbero. Su legado es inmortal y siempre estará en nuestros corazones. </P></div>
      
    <audio class="escuchaArt" controls ><source src="<?php echo base_url(); ?>Assets/musica/musica5.mp3" type="audio/mp3"></div></audio>
    </body>

...
<body class="fondo_inicioArt">
    ...
    <div class="contenedor">
      ...
      <div class="banner" class="contenedor"><br><br><br><br><h1 class="banner__descripcion">Cartel de Santa</h1></div>

      <div><h3 class="noticias_art">Género hip hop.</h3>

      <img src="<?php echo base_url(); ?>Assets/img/mas3.jpg" class="art_img">
      <P class="noticia_art1">#El dolor de la micro#</P>

      <P class="noticia_part">El barrio de Santa Catarina, Nuevo León, fue el lugar que vio nacer en 1999, al Cartel de Santa. Casi 20 años después Eduardo Dávalos mejor conocido como “Babo”, sigue siendo el líder y principal vocal de la agrupación y junto a “Rowan Rabia” (Mono), han mantenido la banda a pesar de la salida de algunos integrantes como Dharius en el 2014.</P></div>

      <br><P class="noticia_part2">Cartel de Santa es uno de los exponentes del hip hop y del rap más reconocidos a nivel nacional, pues temas como “Todas Mueren Por Mí” del 2003, “Si me Ven” del 2006, y “Los Mensajes del Whatsapp” de 2014; siempre son coreados por los fans en sus conciertos, además, se han vuelto parte de la cultura popular mexicana.</P></div>
      
    <audio class="escuchaArt" controls ><source src="<?php echo base_url(); ?>Assets/musica/musica7.mp3" type="audio/mp3"></div></audio>
    </body>

...
<body class="fondo_inicioArt">
    ...
    <div class="contenedor">
      ...
      <img src="<?php echo base_url(); ?>Assets/img/mas5.jpg" class="art_img">
      <P class="noticia_art1">#Ghetto gospel#</P>

      <P class="noticia_part">Tupac Amaru Shakur, también conocido como 2Pac, fue un rapero estadounidense, además de actor, productor y poeta, nacido en el 16 de junio de 1971 en East Harlem, Nueva York y fallecido el 13 de septiembre de 1996 en Las Vegas.</P></div>

      <br><P class="noticia_part2">Es el rapero que más discos ha vendido en la historia, con 50 millones de copias sólo en Estados Unidos y alrededor de 120 millones en el resto del mundo, reconocido por el Libro Guinness de los Récords.</P></div>
      
    <audio class="escuchaArt" controls ><source src="<?php echo base_url(); ?>Assets/musica/musica9.mp3" type="audio/mp3"></div></audio>
    </body>

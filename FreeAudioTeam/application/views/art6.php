...
<body class="fondo_inicioArt">
    ...
    <div class="contenedor">
      ...
      <div class="banner" class="contenedor"><br><br><br><br><h1 class="banner__descripcion">Snoop Dog</h1></div>

      <div><h3 class="noticias_art">Género hip hop.</h3>

      <img src="<?php echo base_url(); ?>Assets/img/mas6.png" class="art_img">
      <P class="noticia_art1">#Drop it like it's hot#</P>

      <P class="noticia_part">
Calvin Cordozar Broadus Jr, Snoop Lion, Snoop Doggy Dogg, Tha Doggfather, The Bigg Boss Dogg, Bigg Snoop Dogg y The D-O Double G son unos de los tantos nombres con los que se le conoce a Snoop Dog. Él es posiblemente el rapero más grande, cotizado y reconocido del espectáculo americano.</P></div>

      <br><P class="noticia_part2">Ha conseguido alcanzar el Olimpo de la Costa Este del rap sin renunciar un solo momento a su actitud callejera, su particular visión del mundo y sus vicios: mujeres, joyas y por supuesto, la hierba. Recientemente ha vuelto a la escena con Bush, su treceavo disco de estudio, un app que distribuye marihuana en los lugares donde ha sido legalizada y su próxima visita a nuestro país. Y antes de que esa visita llegue, hacemos un recorrido por la vida y la carrera del músico </P></div>
      
    <audio class="escuchaArt" controls ><source src="<?php echo base_url(); ?>Assets/musica/musica10.mp3" type="audio/mp3"></div></audio>
    </body>

     <br><br><br><footer ><div class="contenedor">

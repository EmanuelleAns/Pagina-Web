...
<body class="fondo_inicio">
    ...
    <div class="contenedor">
      ...
      <img src="<?php echo base_url(); ?>Assets/img/new2.jpg" class="noticia_img">

      <P class="noticia_p1">Ataraxia "No pienso llorar"   
        Ya escuchamos el Ataraxia; A plena luz del día, nuevo álbum de Charles Ans, y te podemos decir que es una gran propuesta que no debes de dejar pasar para tronar esos audífonos y mover la cabeza al ritmo de bases. Tiene lyrics que riman a la vida, los compas y las morras.
¡Súbele y disfrútalo!</P>

      <audio class="escucha" controls class="reproductor2"><source src="<?php echo base_url(); ?>Assets/musica/musica22.mp3" type="audio/mp3"></div></audio>

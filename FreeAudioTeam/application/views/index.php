...
<body class="fondo_inicio">
    ...
    <div class="contenedor">
        ...
        <ul class="menu"><!--Definir Botones grales-->
          ...
          <li class="menu__item"><a class="menu__link" href="Musica_sin_copyright/inicio">Inicio</a></li>

          <li class="menu__item"><a class="menu__link" href="Musica_sin_copyright/blog">BLOG</a></li>

          <li class="menu__item"><a class="menu__link" href="Musica_sin_copyright/categorias">Categorías</a></li>

          <li class="menu__item"><a class="menu__link" href="Musica_sin_copyright/nosotros">Nosotros</a></li>

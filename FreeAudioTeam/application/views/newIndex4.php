...
<body class="fondo_inicio">
    ...
    <div class="contenedor">
      ...
      <div class="banner" class="contenedor"><br><br><br><br><h1 class="banner__descripcion">Rels B</h1></div>

      <h3 class="noticia">Género hip hop.</h3>

      <img src="<?php echo base_url(); ?>Assets/img/imagen4.jpg" class="noticia_img">

      <P class="noticia_p">Daniel Vidal, mejor conocido como Rels B, es un cantante, compositor y productor musical del género cultural urbano hip hop. Nació el 18 de octubre de 1993 en Palma de Mallorca, España. Es reconocido por ser uno de los pocos artistas que no pertenece a ningún sello discográfico y que ha alcanzado la cima del éxito por su gran talento de manera independiente.</P>
      <P class="noticia_p2">Rels B es un artista español que ha sabido mantenerse en las alturas de la industria sin apoyo de grandes disqueras, ha experimentado con ritmos boombaps, R&B y el trap. Es reconocido en la escena no solo por ser cantante sino también por ser productor.</P>
      <P class="noticia_p3">Yo que te tenía en un pedestal,Yo que te decía que no hay otra igual,Pero me equivoqué, no eras tan especial, Yo valgo más que tú, tú no vales pa' na</P>
      <P class="noticia_p4">Lejos de ti no estoy tan mal,Lejos de ti me sale el plan,Quítate de en medio, no vuelvas más, Sé que sin ti soy el number one</P>

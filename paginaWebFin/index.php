...
<body class="fondo_inicio">
    ...
    <!-----------------------------------------Banner-------------------------------------->
        ...
        <div class="banner"> <!--Definimos clase (contenedor para alinar a todas)--> 
            ...
            <img src="img/fondo1.jpg" alt"" title="" >
        <div class="contenedor">
  ...
  Puedes escuchar todo los temas de manera inmediata, descarga toda la música que quieras.
    ...
    <section class="destino">
        ...
        <div class="contenedor">  
            ...
            <img src="img/new1.jpg" alt="" class="especial__img">
        ...
        <article class="especial__columna2">
          <img src="img/new2.jpg" alt="" class="especial__img">   
                  <div class="informacion">
          ...
          <img src="img/new3.jpg" alt="" class="especial__img">   
                  <div class="informacion">
        ...
        <div class="contenedor">
            ...
            <img src="img/masfin.png" alt="" class="fondo__img">
